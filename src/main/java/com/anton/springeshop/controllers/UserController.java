...
import com.anton.springeshop.service.UserService;
...
public class UserController {
	...
	@GetMapping //при переходе вывод всех юзеров
	...
	@PreAuthorize("isAuthenticated()")
	@PostMapping("/profile")
	public String updateProfileUser(UserDto dto, Model model, Principal principal){ //principal - авторизованный юзер
		if(principal == null
